...
return new class extends Migration
{
    ...
    {
        Schema::create('uc_ext_studentsprotocol', function (Blueprint $table) {
            ...
            $table->string('notefield', 50)->nullable();
            $table->string('notefieldlpp', 10)->nullable();
        });
    }
    ...
    {
        Schema::dropIfExists('uc_ext_studentsprotocol');
    }
};
