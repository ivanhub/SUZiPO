...
[![GitHub Workflow Status](https://github.com/spatie/laravel-activitylog/actions/workflows/run-tests.yml/badge.svg)](https://github.com/spatie/laravel-activitylog/actions/workflows/run-tests.yml)
