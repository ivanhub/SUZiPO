    ...
    <div class="max-w-7xl mx-auto py-12">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-900">Добавление ОТ</h2>
            </div>

            <form action="{{ route('matrices.ot.store') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="training_type" id="training_type" value="{{ old('training_type') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" step="0.01" name="fulltime_theoretical_hours" id="fulltime_theoretical_hours" value="{{ old('fulltime_theoretical_hours') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" step="0.01" name="distance_theoretical_hours" id="distance_theoretical_hours" value="{{ old('distance_theoretical_hours') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" step="0.01" name="practical_hours" id="practical_hours" value="{{ old('practical_hours') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4 md:col-span-2">
                        ...
                        <textarea name="information_system_entry" id="information_system_entry" rows="2"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">{{ old('information_system_entry') }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="code_ucjung" id="code_ucjung" value="{{ old('code_ucjung') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="code_ul" id="code_ul" value="{{ old('code_ul') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
