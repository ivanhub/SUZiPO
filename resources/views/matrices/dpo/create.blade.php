    ...
    <div class="max-w-7xl mx-auto py-12">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-900">Добавление ДПО</h2>
            </div>

            <form action="{{ route('matrices.dpo.store') }}" method="POST" class="p-6">
                @csrf

                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="mb-4">
                        <label for="row_number" class="block text-sm font-medium text-gray-700 mb-1">№ п/п</label>
                        <input type="number" name="row_number" id="row_number" value="{{ old('row_number') }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="dpo_type" id="dpo_type" value="{{ old('dpo_type') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="theoretical_hours" id="theoretical_hours" value="{{ old('theoretical_hours') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="industrial_practice_hours" id="industrial_practice_hours" value="{{ old('industrial_practice_hours') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="student_category" id="student_category" value="{{ old('student_category') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="group_capacity" id="group_capacity" value="{{ old('group_capacity') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="attestation_form" id="attestation_form" value="{{ old('attestation_form') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="issued_document" id="issued_document" value="{{ old('issued_document') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4 md:col-span-3">
                        ...
                        <textarea name="note" id="note" rows="2"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">{{ old('note') }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="uchi_pro" id="uchi_pro" value="{{ old('uchi_pro') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="information_system_entry" id="information_system_entry" value="{{ old('information_system_entry') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
