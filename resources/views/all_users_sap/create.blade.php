    ...
    <div class="max-w-7xl mx-auto py-12">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-900">Добавление пользователя SAP</h2>
            </div>

            <form action="{{ route('all-users-sap.store') }}" method="POST" class="p-6">
                @csrf

                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="mb-4">
                        <label for="tab_number" class="block text-sm font-medium text-gray-700 mb-1">Таб. номер</label>
                        <input type="number" name="tab_number" id="tab_number" value="{{ old('tab_number') }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="gender_key" id="gender_key" value="{{ old('gender_key') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="pfr_certificate" id="pfr_certificate" value="{{ old('pfr_certificate') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="level_4_name" id="level_4_name" value="{{ old('level_4_name') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="level_3_name" id="level_3_name" value="{{ old('level_3_name') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="duv_b" id="duv_b" value="{{ old('duv_b') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="mvz" id="mvz" value="{{ old('mvz') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="employee_category" id="employee_category" value="{{ old('employee_category') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
