            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                ...
                <div x-data="{ open: true }">
                    ...
                    <div x-show="open" 
                        ...
                        <a href="{{ route('directories.educational-institutions') }}" class="block px-3 py-2 text-sm text-gray-600 hover:text-indigo-600 hover:bg-gray-50 rounded-lg transition-colors duration-150">Учебные заведения</a>
                        <a href="{{ route('directories.courses') }}" class="block px-3 py-2 text-sm text-gray-600 hover:text-indigo-600 hover:bg-gray-50 rounded-lg transition-colors duration-150">Курсы</a>
                        <a href="{{ route('directories.cities') }}" class="block px-3 py-2 text-sm text-gray-600 hover:text-indigo-600 hover:bg-gray-50 rounded-lg transition-colors duration-150">Города</a>
                        <a href="{{ route('directories.professions') }}" class="block px-3 py-2 text-sm text-gray-600 hover:text-indigo-600 hover:bg-gray-50 rounded-lg transition-colors duration-150">Профессии</a>
                        ...
                        <a href="{{ route('directories.training-types') }}" class="block px-3 py-2 text-sm text-gray-600 hover:text-indigo-600 hover:bg-gray-50 rounded-lg transition-colors duration-150">Виды обучения</a>
                        ...
                        <a href="{{ route('directories.reasons-training') }}" class="block px-3 py-2 text-sm text-gray-600 hover:text-indigo-600 hover:bg-gray-50 rounded-lg transition-colors duration-150">Причины обучения</a>
