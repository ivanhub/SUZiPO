    ...
    <div class="max-w-3xl mx-auto py-12">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-900">Редактирование типа мероприятия</h2>
            </div>

            <form action="{{ route('directories.events-type.update', $eventsType) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
                ...
                <div class="mb-4">
                    ...
                    <input type="text" 
                           name="name" 
                           id="name" 
                           value="{{ old('name', $eventsType->name) }}"
