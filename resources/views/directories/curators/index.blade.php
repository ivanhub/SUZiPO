    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <!-- Поиск с автофокусом -->
                <div class="mb-4">
                    <form method="GET" action="{{ route('directories.curators.index') }}" id="searchForm">
                        <div class="flex gap-2">
                            <div class="relative flex-1">
                                <input type="text" 
                                       name="search" 
                                       value="{{ request('search') }}"
                                       placeholder="Поиск по кураторам... (регистронезависимый)"
                ...
                <div class="flex justify-between items-center mb-4">
                    <h2 class="text-lg font-semibold text-gray-900">Кураторы групп</h2>
                    <a href="{{ route('directories.curators.create') }}" 
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-4 text-center text-sm text-gray-500">
                                    @if(request('search'))
                                        Кураторы по запросу "{{ request('search') }}" не найдены.
                                    @else
                                        Нет записей
                                    @endif
                                </td>
                ...
                <div class="mt-4">
                    {{ $curators->appends(request()->query())->links() }}
                </div>
