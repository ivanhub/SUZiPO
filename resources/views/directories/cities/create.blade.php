    ...
    <div class="max-w-2xl mx-auto py-12">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-900">Добавление города</h2>
            </div>

            <form action="{{ route('directories.cities.store') }}" method="POST" class="p-6">
                @csrf
                ...
                <div class="mb-4">
                    <label for="city" class="block text-sm font-medium text-gray-700 mb-2">Название города</label>
                    <input type="text" 
                           name="city" 
                           id="city" 
                           value="{{ old('city') }}"
