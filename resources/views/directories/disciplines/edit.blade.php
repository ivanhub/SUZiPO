    ...
    <div class="max-w-3xl mx-auto py-12">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-semibold text-gray-900">Редактирование дисциплины</h2>
            </div>

            <form action="{{ route('directories.disciplines.update', $discipline) }}" method="POST" class="p-6">
                @csrf
                @method('PUT')
